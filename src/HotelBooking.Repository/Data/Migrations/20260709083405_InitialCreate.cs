        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_DateRange", "[CheckInDate] < [CheckOutDate]");
                    table.CheckConstraint("CK_Bookings_GuestCount", "[GuestCount] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_HotelId_RoomType_Capacity",
                table: "Rooms",
                columns: new[] { "HotelId", "RoomType", "Capacity" });
        }
